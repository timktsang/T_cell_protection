...
for (i in 1:2){
  ...
  if (sum(tempdata$AT1>=3)>0){
    ...
    #  a2 <- glm(inf ~ I(CD4.sH1*multipler) + I(CD8.sH1*multipler)   + season + HAIpos  ,data=tempdata,family="binomial")
    ...
    a1 <- geeglm(inf ~ I(CD4.sH1*multipler) + I(CD8.sH1*multipler)   + season2 + HAIpos  ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
    ...
    a1 <- geeglm(inf ~ I(CD4.sH1*multipler) + I(CD8.sH1*multipler)   + season2  ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
  ...
  if (sum(!is.na(tempdata$CD4.pH1))>0){
    if (sum(tempdata$AT1>=3)>0&sum(!is.na(tempdata$CD4.pH1))>0){
      ...
      a1 <- geeglm(inf ~ I(CD4.pH1*multipler) + I(CD8.pH1*multipler)   + season2 + HAIpos ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
    ...
    if (sum(tempdata$AT1>=3)==0&sum(!is.na(tempdata$CD4.pH1))>0){
      ...
      a1 <- geeglm(inf ~ I(CD4.pH1*multipler) + I(CD8.pH1*multipler)   + season2  ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
  ...
  if (sum(tempdata$AT1>=3)>0){
    ...
    a1 <- geeglm(inf ~ I(CD4.sH3*multipler) + I(CD8.sH3*multipler)   + season2 + HAIpos ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
    ...
    a1 <- geeglm(inf ~ I(CD4.sH3*multipler) + I(CD8.sH3*multipler)   + season2  ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
  ...
  if (sum(tempdata$AT1>=3)>0){
    ...
    a1 <- geeglm(inf ~ I(CD4.sH1*multipler)   + season2 + HAIpos ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
    ...
    a1 <- geeglm(inf ~ I(CD4.sH1*multipler)   + season2  ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
  ...
  if (sum(!is.na(tempdata$CD4.pH1))>0){
    if (sum(tempdata$AT1>=3)>0&sum(!is.na(tempdata$CD4.pH1))>0){
      ...
      a1 <- geeglm(inf ~ I(CD4.pH1*multipler)   + season2 + HAIpos ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
    ...
    if (sum(tempdata$AT1>=3)==0&sum(!is.na(tempdata$CD4.pH1))>0){
      ...
      a1 <- geeglm(inf ~ I(CD4.pH1*multipler)   + season2  ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
  ...
  if (sum(tempdata$AT1>=3)>0){
    ...
    a1 <- geeglm(inf ~ I(CD4.sH3*multipler)   + season2 + HAIpos ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
    ...
    a1 <- geeglm(inf ~ I(CD4.sH3*multipler)   + season2  ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
  ...
  if (sum(tempdata$AT1>=3)>0){
    ...
    a1 <- geeglm(inf ~ I(CD8.sH1*multipler)   + season2 + HAIpos  ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
    ...
    a1 <- geeglm(inf ~ I(CD8.sH1*multipler)   + season2   ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
  ...
  if (sum(!is.na(tempdata$CD4.pH1))>0){
    if (sum(tempdata$AT1>=3)>0&sum(!is.na(tempdata$CD4.pH1))>0){
      ...
      a1 <- geeglm(inf ~ I(CD8.pH1*multipler)   + season2 + HAIpos  ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
    ...
    if (sum(tempdata$AT1>=3)==0&sum(!is.na(tempdata$CD4.pH1))>0){
      ...
      a1 <- geeglm(inf ~ I(CD8.pH1*multipler)   + season2   ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
  ...
  if (sum(tempdata$AT1>=3)>0){
    ...
    a1 <- geeglm(inf ~ I(CD8.sH3*multipler)   + season2 + HAIpos   ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
    ...
    a1 <- geeglm(inf ~ I(CD8.sH3*multipler)   + season2   ,data=tempdata1,id = hhID, waves = uid,family="binomial", corstr="exchangeable")
...
rowname <- c("Children (age less than 18)",
             " pH1N1 infections",
...
pdf("Shared kiddivax CMI/protection/figure3.pdf",width=12, height=10)
